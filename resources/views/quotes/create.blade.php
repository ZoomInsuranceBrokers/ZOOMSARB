...
@section('content')
    <div style="max-width: 1050px; margin: 0 auto;">
        <div style="background: linear-gradient(135deg, #e3f0ff 0%, #f7faff 100%); border-radius: 18px; box-shadow: 0 2px 16px #2e319222; padding: 2.5rem 2rem; margin-bottom: 2rem; animation: fadeInDown 1s;">
            ...
            <form method="POST" action="{{ route('quotes.store') }}">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 1.5rem; margin-top:1.2rem;">
                    ...
                    <div style="flex:1 1 400px;">
                        ...
                        <input type="text" id="policy_period" name="policy_period" class="form-input" placeholder="e.g. 01/01/2025 - 31/12/2025">
                    </div>
                </div>
                <div style="display: flex; flex-wrap: wrap; gap: 1.5rem; margin-top:1.2rem;">
                    <div style="flex:1 1 400px;">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 1.5rem; margin-top:1.2rem;">
                    <div style="flex:1 1 300px;">
                        ...
                        <input type="number" id="property_damage" name="property_damage" class="form-input" min="0" step="any" oninput="updateTotalSumInsured()">
                    </div>
                    <div style="flex:1 1 300px;">
                        <label for="business_interruption" style="color:#2e3192; font-weight:600;">Business Interruption</label>
                        <input type="number" id="business_interruption" name="business_interruption" class="form-input" min="0" step="any" oninput="updateTotalSumInsured()">
                    </div>
                    <div style="flex:1 1 300px;">
                        <label for="total_sum_insured" style="color:#2e3192; font-weight:600;">Total Sum Insured</label>
                        <input type="number" id="total_sum_insured" name="total_sum_insured" class="form-input" readonly style="background:#e3f0ff;">
                    </div>
                </div>
                <div style="margin-top:1.2rem;">
                ...
                <div style="margin-top:1.2rem;">
                    ...
                    <div id="indemnityLimitsWrapper">
                        <input type="text" name="limit_of_indemnity[]" class="form-input" placeholder="Enter limit of indemnity">
                    </div>
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 1.5rem; margin-top:1.2rem;">
                    ...
                    <div style="flex:1 1 400px;">
                        ...
                        <input type="text" id="additional_covers" name="additional_covers" class="form-input">
                    </div>
                </div>
                <div style="margin-top:1.2rem;">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 1.5rem; margin-top:1.2rem;">
                    <div style="flex:1 1 400px;">
                        ...
                        <input type="text" id="deductibles" name="deductibles" class="form-input">
                    </div>
                    <div style="flex:1 1 400px;">
                ...
                <div style="text-align:center; margin-top:2rem;">
                    <button type="button" id="addRemarkBtn" style="background: linear-gradient(90deg, #2e3192 0%, #1bffff 100%); color: #fff; border: none; border-radius: 8px; padding: 0.7rem 2.2rem; font-size: 1.05rem; font-weight: 600; cursor: pointer; box-shadow: 0 2px 8px #2e319222; transition: background 0.2s;">
